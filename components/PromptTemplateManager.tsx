        ...
        <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
            />
            {searchTerm && (
              <button
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="md:hidden text-xs text-purple-600 hover:text-purple-800 dark:text-purple-400 dark:hover:text-purple-300 font-medium"
              >
            ...
            <div className={`flex flex-wrap items-center gap-2 transition-all duration-200 ${
              !tagsExpanded ? 'max-h-16 overflow-hidden md:max-h-none md:overflow-visible' : ''
            }`}>
              {allTags.map(tag => (
                <button
                  key={tag}
