  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex-1 flex flex-col min-w-0">
            ...
            <div className="flex items-center justify-center h-full p-4">
              ...
              >
                <div className="text-center mb-8">
                  ...
                  >
                    Your intelligent AI assistant powered by local models. Start a conversation below or browse your previous chats.
                  </motion.p>
                </div>
                  ...
                  <div className="space-y-4">
                    <div className="relative">
                      <textarea
                        ...
                        className="w-full px-4 py-4 border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent resize-none text-base transition-colors"
                        rows={4}
                        disabled={isLoading}
                      />
        ...
        {/* Input for existing conversations */}
        {currentConversation && (
